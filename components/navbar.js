function navbar(){
    ...
    <div id="navbar_box">
        ...
        <div class="nav-search-form">
            <form action=""><input type="text" placeholder="Search free high resolution photos" id="search"/> </form>
        </div>

            <div class="navbar_right"> <a href="#"> Advertise</a> </div>


            <div style="margin-top: 10px;"> <a href="#">Blog</a> </div>
